    ...
    <>
      <div className="flex gap-6 mb-4">
        ...
        <label className="flex items-center gap-2 cursor-pointer">
          <input
            ...
            className="w-4 h-4 text-indigo-600"
          />
          <span className="text-sm font-semibold text-gray-700">Multicity</span>
        </label>
      </div>
      ...
      {/* <div className="mt-4">
        <label className="block text-xs font-bold text-gray-700 mb-3 uppercase">
          Select A Special Fare Type
        </label>

        <div className="flex flex-wrap gap-3">
          <button className="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-full text-sm font-medium border-2 border-gray-200 hover:border-indigo-500 transition-all">
            Student Fare
          </button>
          <button className="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-full text-sm font-medium border-2 border-gray-200 hover:border-indigo-500 transition-all">
            Senior Citizen Fare
